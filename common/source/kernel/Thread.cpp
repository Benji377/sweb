...
Thread::Thread(FileSystemInfo *working_dir, ustl::string name, Thread::TYPE type) :
    ...
    next_thread_in_lock_waiters_list_(0), lock_waiting_on_(0), holding_lock_list_(0), name_(ustl::move(name)),
    state_(Running), tid_(0), my_terminal_(0), working_dir_(working_dir)
{
